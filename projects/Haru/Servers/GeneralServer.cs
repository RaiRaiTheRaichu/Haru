    ...
    public class GeneralServer
    {
        ...
        public GeneralServer()
        {
            ...
            Server.Controllers = new Dictionary<string, Controller>()
            {
                ...
                { "/client/game/keepalive",                         new GameKeepaliveController() },
                ...
                { "/client/quest/list",                             new QuestListController() },
                { "/client/repeatalbeQuests/activityPeriods",       new RepeatableQuestController() },
